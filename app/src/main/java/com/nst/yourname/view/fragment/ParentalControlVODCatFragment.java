...
public class ParentalControlVODCatFragment extends Fragment {
    ...
    public static ParentalControlVODCatFragment newInstance(String str, String str2) {
        ParentalControlVODCatFragment parentalControlVODCatFragment = new ParentalControlVODCatFragment();
        Bundle bundle = new Bundle();
        bundle.putString(ARG_PARAM1, str);
        bundle.putString(ARG_PARAM2, str2);
        parentalControlVODCatFragment.setArguments(bundle);
    ...
    private void initializeData() {
        ...
        ArrayList<LiveStreamCategoryIdDBModel> allMovieCategoriesHavingParentIdZero = liveStreamDBHandler2.getAllMovieCategoriesHavingParentIdZero();
        this.countUncat = liveStreamDBHandler2.getUncatCount("-3", AppConst.EVENT_TYPE_MOVIE);
        ...
        if (this.countUncat != 0 && this.countUncat > 0) {
            ...
            allMovieCategoriesHavingParentIdZero.add(allMovieCategoriesHavingParentIdZero.size(), liveStreamCategoryIdDBModel);
        }
        HashMap hashMap = new HashMap();
        if (allMovieCategoriesHavingParentIdZero != null) {
        ...
        if (allMovieCategoriesHavingParentIdZero != null && allMovieCategoriesHavingParentIdZero.size() > 0 && this.myRecyclerView != null && this.emptyView != null) {
            this.myRecyclerView.setVisibility(0);
            this.emptyView.setVisibility(8);
            this.mAdapter = new ParentalControlVODCatAdapter(allMovieCategoriesHavingParentIdZero, getContext(), this.dashboardActivity, this.fontOPenSansBold);
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_search:
                ...
                this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlVODCatFragment.AnonymousClass1 */
                    ...
                    public boolean onQueryTextChange(String str) {
                        ...
                        ParentalControlVODCatFragment.this.mAdapter.filter(str, ParentalControlVODCatFragment.this.emptyView, ParentalControlVODCatFragment.this.progressDialog);
                        return true;
                    }
                });
                return true;
            case R.id.menu_load_channels_vod1:
                ...
                builder.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlVODCatFragment.AnonymousClass2 */

                    public void onClick(DialogInterface dialogInterface, int i) {
                    }
                });
                builder.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlVODCatFragment.AnonymousClass3 */
            ...
            case R.id.menu_load_tv_guide1:
                ...
                builder2.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlVODCatFragment.AnonymousClass4 */
                ...
                builder2.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlVODCatFragment.AnonymousClass5 */
