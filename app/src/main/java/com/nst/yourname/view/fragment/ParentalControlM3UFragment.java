...
public class ParentalControlM3UFragment extends Fragment {
    ...
    public static ParentalControlM3UFragment newInstance(String str, String str2) {
        ParentalControlM3UFragment parentalControlM3UFragment = new ParentalControlM3UFragment();
        Bundle bundle = new Bundle();
        bundle.putString(ARG_PARAM1, str);
        bundle.putString(ARG_PARAM2, str2);
        parentalControlM3UFragment.setArguments(bundle);
        return parentalControlM3UFragment;
    }
    ...
    private void initializeData() {
        ...
        ArrayList<LiveStreamCategoryIdDBModel> allm3uCategories = liveStreamDBHandler2.getAllm3uCategories();
        this.countUncat = liveStreamDBHandler2.getUncatCountM3UALL(false);
        ...
        if (allm3uCategories != null) {
            Iterator<LiveStreamCategoryIdDBModel> it = allm3uCategories.iterator();
            while (it.hasNext()) {
        ...
        if (allm3uCategories != null && allm3uCategories.size() > 0 && this.myRecyclerView != null && this.emptyView != null) {
            this.myRecyclerView.setVisibility(0);
            this.emptyView.setVisibility(8);
            this.mAdapter = new ParentalControlVODCatAdapter(allm3uCategories, getContext(), this.dashboardActivity, this.fontOPenSansBold);
        ...
        switch (menuItem.getItemId()) {
            ...
            case R.id.action_search:
                ...
                this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlM3UFragment.AnonymousClass1 */
                    ...
                    public boolean onQueryTextChange(String str) {
                        ...
                        if (ParentalControlM3UFragment.this.progressDialog != null) {
                            ParentalControlM3UFragment.this.progressDialog.dismiss();
                        }
                        if (ParentalControlM3UFragment.this.emptyView == null || ParentalControlM3UFragment.this.mAdapter == null) {
                            return true;
                        }
                        ParentalControlM3UFragment.this.emptyView.setVisibility(8);
                        ParentalControlM3UFragment.this.mAdapter.filter(str, ParentalControlM3UFragment.this.emptyView, ParentalControlM3UFragment.this.progressDialog);
                        return true;
                    }
                });
                return true;
            case R.id.menu_load_channels_vod1:
                ...
                builder.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlM3UFragment.AnonymousClass2 */

                    public void onClick(DialogInterface dialogInterface, int i) {
                    }
                });
                builder.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlM3UFragment.AnonymousClass3 */
            ...
            case R.id.menu_load_tv_guide1:
                ...
                builder2.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlM3UFragment.AnonymousClass4 */

                    public void onClick(DialogInterface dialogInterface, int i) {
                        Utils.loadTvGuid(ParentalControlM3UFragment.this.context);
                    }
                });
                builder2.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                    /* class com.nst.yourname.view.fragment.ParentalControlM3UFragment.AnonymousClass5 */
