...
public class PlayExternalPlayerActivity extends AppCompatActivity {
    ...
    public void mxPlayerNotFoundDialogBox() {
        ...
        builder.setPositiveButton(getResources().getString(R.string.install_it), new DialogInterface.OnClickListener() {
            /* class com.nst.yourname.view.activity.PlayExternalPlayerActivity.AnonymousClass1 */
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                playExternalPlayerActivity.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("market://details?id=" + PlayExternalPlayerActivity.this.packagename)));
                try {
                    PlayExternalPlayerActivity playExternalPlayerActivity2 = PlayExternalPlayerActivity.this;
                    playExternalPlayerActivity2.startActivity(new Intent("android.intent.action.VIEW", Uri.parse("http://play.google.com/store/apps/details?id=" + PlayExternalPlayerActivity.this.packagename)));
        ...
        builder.setNegativeButton(getResources().getString(R.string.cancel_small), new DialogInterface.OnClickListener() {
            /* class com.nst.yourname.view.activity.PlayExternalPlayerActivity.AnonymousClass2 */
