...
public class EPGTimeShiftActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_epgtime_shift);
    ...
    public void doWork() {
        runOnUiThread(new Runnable() {
            /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass1 */

            public void run() {
                try {
                    String date = Calendar.getInstance().getTime().toString();
                    String time = Utils.getTime(EPGTimeShiftActivity.this.context);
                    String date2 = Utils.getDate(date);
                    if (EPGTimeShiftActivity.this.time != null) {
                        EPGTimeShiftActivity.this.time.setText(time);
                    }
                    if (EPGTimeShiftActivity.this.date != null) {
                        EPGTimeShiftActivity.this.date.setText(date2);
                    }
    ...
    private void initialize() {
        ...
        this.logo.setOnClickListener(new View.OnClickListener() {
            /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass2 */

            public void onClick(View view) {
                Utils.Redrirect_to_Home(EPGTimeShiftActivity.this.context);
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.action_logout && this.context != null) {
            new AlertDialog.Builder(this.context, R.style.AlertDialogCustom).setTitle(getResources().getString(R.string.logout_title)).setMessage(getResources().getString(R.string.logout_message)).setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass4 */

                public void onClick(DialogInterface dialogInterface, int i) {
                    Utils.logoutUser(EPGTimeShiftActivity.this.context);
                }
            }).setNegativeButton(getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass3 */
        ...
        if (itemId == R.id.menu_load_channels_vod) {
            ...
            builder.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass5 */
            ...
            builder.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass6 */
        ...
        if (itemId == R.id.menu_load_tv_guide) {
            ...
            builder2.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass7 */
            ...
            builder2.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.EPGTimeShiftActivity.AnonymousClass8 */
