...
import com.nst.yourname.view.adapter.EPGAdapterCategoriesNewFlow;
...
public class NewEPGCategoriesActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    public AsyncTask AsyncTaskNewEPGCategoriesActivity = null;
    ...
    public void onCreate(Bundle bundle) {
        ...
        setContentView((int) R.layout.activity_epg_categories_new_flow);
        ...
        this.SharedPreferencesSort = getSharedPreferences(AppConst.LOGIN_PREF_SORT_EPG, 0);
        ...
        this.logo.setOnClickListener(new View.OnClickListener() {
            /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass1 */
    ...
    class NewEPGCategoriesActivityAsync extends AsyncTask<String, Void, Boolean> {
        ...
        public void onPostExecute(Boolean bool) {
            ...
            if (NewEPGCategoriesActivity.this.liveListDetailAvailable != null) {
                NewEPGCategoriesActivity.this.adapter = new EPGAdapterCategoriesNewFlow(NewEPGCategoriesActivity.this.liveListDetailAvailable, NewEPGCategoriesActivity.this.context);
                if ((NewEPGCategoriesActivity.this.getResources().getConfiguration().screenLayout & 15) == 3) {
                    GridLayoutManager unused = NewEPGCategoriesActivity.this.gridLayoutManager = new GridLayoutManager(NewEPGCategoriesActivity.this.context, 2);
                } else {
                    GridLayoutManager unused2 = NewEPGCategoriesActivity.this.gridLayoutManager = new GridLayoutManager(NewEPGCategoriesActivity.this.context, 2);
                }
                NewEPGCategoriesActivity.this.myRecyclerView.setLayoutManager(NewEPGCategoriesActivity.this.gridLayoutManager);
                NewEPGCategoriesActivity.this.myRecyclerView.setItemAnimator(new DefaultItemAnimator());
                NewEPGCategoriesActivity.this.myRecyclerView.setAdapter(NewEPGCategoriesActivity.this.adapter);
                if (NewEPGCategoriesActivity.this.pbLoader != null) {
                    NewEPGCategoriesActivity.this.pbLoader.setVisibility(8);
                }
            }
        }
    }
                    ...
                    if (this.liveListDetailAvailable != null && this.liveListDetailAvailable.size() > 0) {
                        ...
                        while (true) {
                            if (i < this.liveListDetailAvailable.size()) {
                                if (this.AsyncTaskNewEPGCategoriesActivity != null && this.AsyncTaskNewEPGCategoriesActivity.isCancelled()) {
                                    break;
                                }
    ...
    public void onDestroy() {
        super.onDestroy();
        if (this.AsyncTaskNewEPGCategoriesActivity != null && this.AsyncTaskNewEPGCategoriesActivity.getStatus().equals(AsyncTask.Status.RUNNING)) {
    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.action_logout1 && this.context != null) {
            new AlertDialog.Builder(this.context, R.style.AlertDialogCustom).setTitle(getResources().getString(R.string.logout_title)).setMessage(getResources().getString(R.string.logout_message)).setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass3 */

                public void onClick(DialogInterface dialogInterface, int i) {
                    Utils.logoutUser(NewEPGCategoriesActivity.this.context);
                }
            }).setNegativeButton(getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass2 */
        ...
        if (itemId == R.id.action_search) {
            ...
            this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass4 */
        ...
        if (itemId == R.id.menu_load_channels_vod1) {
            ...
            builder.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass5 */
            ...
            builder.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass6 */
        ...
        if (itemId == R.id.menu_load_tv_guide1) {
            ...
            builder2.setPositiveButton(this.context.getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass7 */
            ...
            builder2.setNegativeButton(this.context.getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass8 */
    ...
    private void showSortPopup(Activity activity) {
        try {
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass9 */

                public void onClick(View view) {
                    NewEPGCategoriesActivity.this.changeSortPopUp.dismiss();
                }
            });
            button.setOnClickListener(new View.OnClickListener() {
                /* class com.nst.yourname.view.activity.NewEPGCategoriesActivity.AnonymousClass10 */
                ...
                public void onClick(View view) {
                    ...
                    if (radioButton.getText().toString().equals(NewEPGCategoriesActivity.this.getResources().getString(R.string.sort_atoz))) {
                        ...
                        NewEPGCategoriesActivity.this.SharedPreferencesSortEditor.putString(AppConst.LOGIN_PREF_SORT, AppConst.PASSWORD_UNSET);
                        NewEPGCategoriesActivity.this.SharedPreferencesSortEditor.commit();
                    }
                    AsyncTask unused = NewEPGCategoriesActivity.this.AsyncTaskNewEPGCategoriesActivity = new NewEPGCategoriesActivityAsync().executeOnExecutor(AsyncTask.THREAD_POOL_EXECUTOR, new String[0]);
                    NewEPGCategoriesActivity.this.changeSortPopUp.dismiss();
                }
            });
        } catch (Exception unused) {
