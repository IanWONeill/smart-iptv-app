...
import com.nst.yourname.view.fragment.NewEPGFragment;
...
public class NewEPGCategoriesAdapter extends FragmentPagerAdapter {
    ...
    public NewEPGCategoriesAdapter(List<LiveStreamCategoryIdDBModel> list, FragmentManager fragmentManager, Context context2) {
    ...
    public Fragment getItem(int i) {
        return NewEPGFragment.newInstance(this.LiveStreamCategoriesIds[i], this.liveStreamCategoriesNames[i]);
    }
    ...
    public NewEPGFragment getFragment(int i) {
        String str = this.mFragmentTags.get(Integer.valueOf(i));
        if (str == null) {
            return null;
        }
        return (NewEPGFragment) this.mFragmentManager.findFragmentByTag(str);
    }
}
