...
import com.nst.yourname.view.fragment.LiveStreamsFragment;
...
public class LiveStreamCategoriesAdapter extends FragmentPagerAdapter {
    ...
    public LiveStreamCategoriesAdapter(List<LiveStreamCategoryIdDBModel> list, FragmentManager fragmentManager, Context context2) {
