...
public class NSTIJKPlayerMulti3 extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private Query $;
    Handler EPGHandler;
    public String TAG = "NSTIJKPlayerMulti3";
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new IMediaPlayer.OnBufferingUpdateListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass7 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnBufferingUpdateListener
        public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i) {
            int unused = NSTIJKPlayerMulti3.this.mCurrentBufferPercentage = i;
        }
    };
    ...
    private IMediaPlayer.OnCompletionListener mCompletionListener = new IMediaPlayer.OnCompletionListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass4 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnCompletionListener
        public void onCompletion(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti3.this.mCurrentState = 5;
            int unused2 = NSTIJKPlayerMulti3.this.mTargetState = 5;
    ...
    private IMediaPlayer.OnErrorListener mErrorListener = new IMediaPlayer.OnErrorListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass6 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnErrorListener
        public boolean onError(IMediaPlayer iMediaPlayer, int i, int i2) {
            String access$1800 = NSTIJKPlayerMulti3.this.TAG;
            Log.d(access$1800, "Error: " + i + "," + i2);
            int unused = NSTIJKPlayerMulti3.this.mCurrentState = -1;
            int unused2 = NSTIJKPlayerMulti3.this.mTargetState = -1;
            if (NSTIJKPlayerMulti3.this.mMediaController != null) {
                NSTIJKPlayerMulti3.this.mMediaController.hide();
            }
            NSTIJKPlayerMulti3.this.statusChange(-1);
    ...
    private IMediaPlayer.OnInfoListener mInfoListener = new IMediaPlayer.OnInfoListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass5 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnInfoListener
        public boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i2) {
            if (NSTIJKPlayerMulti3.this.mOnInfoListener != null) {
                NSTIJKPlayerMulti3.this.mOnInfoListener.onInfo(iMediaPlayer, i, i2);
            }
            switch (i) {
                case 3:
                    NSTIJKPlayerMulti3.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_VIDEO_RENDERING_START:");
                    break;
                case 700:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_VIDEO_TRACK_LAGGING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_START /*701*/:
                    NSTIJKPlayerMulti3.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_BUFFERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_END /*702*/:
                    NSTIJKPlayerMulti3.this.statusChange(6);
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_BUFFERING_END:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NETWORK_BANDWIDTH /*703*/:
                    ...
                    break;
                case 800:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_BAD_INTERLEAVING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE /*801*/:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_NOT_SEEKABLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_METADATA_UPDATE /*802*/:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_METADATA_UPDATE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_UNSUPPORTED_SUBTITLE /*901*/:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_UNSUPPORTED_SUBTITLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_SUBTITLE_TIMED_OUT /*902*/:
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_SUBTITLE_TIMED_OUT:");
                    break;
                case 10001:
                    int unused = NSTIJKPlayerMulti3.this.mVideoRotationDegree = i2;
                    String access$18002 = NSTIJKPlayerMulti3.this.TAG;
                    Log.d(access$18002, "MEDIA_INFO_VIDEO_ROTATION_CHANGED: " + i2);
                    if (NSTIJKPlayerMulti3.this.mRenderView != null) {
                        NSTIJKPlayerMulti3.this.mRenderView.setVideoRotation(i2);
                        break;
                    }
                    break;
                case 10002:
                    NSTIJKPlayerMulti3.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_AUDIO_RENDERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_OPEN_INPUT /*10005*/:
                    NSTIJKPlayerMulti3.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti3.this.TAG, "MEDIA_INFO_OPEN_INPUT:");
                    break;
            }
            return true;
        }
    ...
    IMediaPlayer.OnPreparedListener mPreparedListener = new IMediaPlayer.OnPreparedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass3 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnPreparedListener
        public void onPrepared(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti3.this.mCurrentState = 2;
            ...
            int unused2 = NSTIJKPlayerMulti3.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused3 = NSTIJKPlayerMulti3.this.mVideoHeight = iMediaPlayer.getVideoHeight();
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass8 */
        ...
        public void onSurfaceChanged(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2, int i3) {
            ...
            int unused = NSTIJKPlayerMulti3.this.mSurfaceWidth = i2;
            int unused2 = NSTIJKPlayerMulti3.this.mSurfaceHeight = i3;
            boolean z = false;
        ...
        public void onSurfaceCreated(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2) {
            ...
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti3.this.mSurfaceHolder = iSurfaceHolder;
        ...
        public void onSurfaceDestroyed(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder) {
            ...
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti3.this.mSurfaceHolder = null;
    ...
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener = new IMediaPlayer.OnVideoSizeChangedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass2 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnVideoSizeChangedListener
        public void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i, int i2, int i3, int i4) {
            int unused = NSTIJKPlayerMulti3.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused2 = NSTIJKPlayerMulti3.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            int unused3 = NSTIJKPlayerMulti3.this.mVideoSarNum = iMediaPlayer.getVideoSarNum();
            int unused4 = NSTIJKPlayerMulti3.this.mVideoSarDen = iMediaPlayer.getVideoSarDen();
            if (NSTIJKPlayerMulti3.this.mVideoWidth != 0 && NSTIJKPlayerMulti3.this.mVideoHeight != 0) {
                if (NSTIJKPlayerMulti3.this.mRenderView != null) {
                    NSTIJKPlayerMulti3.this.mRenderView.setVideoSize(NSTIJKPlayerMulti3.this.mVideoWidth, NSTIJKPlayerMulti3.this.mVideoHeight);
                    NSTIJKPlayerMulti3.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerMulti3.this.mVideoSarNum, NSTIJKPlayerMulti3.this.mVideoSarDen);
    ...
    public NSTIJKPlayerMulti3(Context context2) {
        super(context2);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti3(Context context2, AttributeSet attributeSet) {
        super(context2, attributeSet);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti3(Context context2, AttributeSet attributeSet, int i) {
    ...
    private void showStatus(String str) {
        this.$.id(R.id.video_view_3).gone();
    ...
    public void statusChange(int i) {
        ...
        if (i == -1) {
            ...
            this.handler.postDelayed(new Runnable() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti3.AnonymousClass1 */

                public void run() {
                    NSTIJKPlayerMulti3.this.retryCount++;
                    NSTIJKPlayerMulti3.this.hideAll();
                    Utils.showToast(NSTIJKPlayerMulti3.this.mActivity, NSTIJKPlayerMulti3.this.mActivity.getResources().getString(R.string.play_back_error) + " (" + NSTIJKPlayerMulti3.this.retryCount + "/" + NSTIJKPlayerMulti3.this.maxRetry + ")");
                    NSTIJKPlayerMulti3.this.openVideo();
                    NSTIJKPlayerMulti3.this.start();
                }
            }, 3000);
            ...
            this.retryCount = 0;
            this.$.id(R.id.app_video_status_3).gone();
            this.$.id(R.id.video_view_3).visible();
            this.$.id(R.id.exo_play).gone();
            this.$.id(R.id.exo_pause).visible();
            this.$.id(R.id.app_video_loading_3).gone();
        } else if (i == 2) {
    ...
    public void hideTitleBarAndFooter() {
        ...
        this.$.id(R.id.ll_seekbar_time_3).gone();
        this.handler.removeCallbacksAndMessages(null);
    }
