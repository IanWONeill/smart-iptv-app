...
public class NSTIJKPlayerMulti1 extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private Query $;
    Handler EPGHandler;
    public String TAG = "NSTIJKPlayerMulti1";
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new IMediaPlayer.OnBufferingUpdateListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass7 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnBufferingUpdateListener
        public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i) {
            int unused = NSTIJKPlayerMulti1.this.mCurrentBufferPercentage = i;
        }
    };
    ...
    private IMediaPlayer.OnCompletionListener mCompletionListener = new IMediaPlayer.OnCompletionListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass4 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnCompletionListener
        public void onCompletion(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti1.this.mCurrentState = 5;
            int unused2 = NSTIJKPlayerMulti1.this.mTargetState = 5;
            if (NSTIJKPlayerMulti1.this.mMediaController != null) {
                NSTIJKPlayerMulti1.this.mMediaController.hide();
            }
            NSTIJKPlayerMulti1.this.statusChange(-1);
            if (NSTIJKPlayerMulti1.this.mOnCompletionListener != null) {
                NSTIJKPlayerMulti1.this.mOnCompletionListener.onCompletion(NSTIJKPlayerMulti1.this.mMediaPlayer);
            }
        }
    };
    ...
    private IMediaPlayer.OnErrorListener mErrorListener = new IMediaPlayer.OnErrorListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass6 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnErrorListener
        public boolean onError(IMediaPlayer iMediaPlayer, int i, int i2) {
            String access$1800 = NSTIJKPlayerMulti1.this.TAG;
            Log.d(access$1800, "Error: " + i + "," + i2);
            int unused = NSTIJKPlayerMulti1.this.mCurrentState = -1;
            int unused2 = NSTIJKPlayerMulti1.this.mTargetState = -1;
            if (NSTIJKPlayerMulti1.this.mMediaController != null) {
                NSTIJKPlayerMulti1.this.mMediaController.hide();
            }
            NSTIJKPlayerMulti1.this.statusChange(-1);
            return (NSTIJKPlayerMulti1.this.mOnErrorListener == null || NSTIJKPlayerMulti1.this.mOnErrorListener.onError(NSTIJKPlayerMulti1.this.mMediaPlayer, i, i2)) ? true : true;
        }
    };
    private Map<String, String> mHeaders;
    private IMediaPlayer.OnInfoListener mInfoListener = new IMediaPlayer.OnInfoListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass5 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnInfoListener
        public boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i2) {
            if (NSTIJKPlayerMulti1.this.mOnInfoListener != null) {
                NSTIJKPlayerMulti1.this.mOnInfoListener.onInfo(iMediaPlayer, i, i2);
            }
            switch (i) {
                case 3:
                    NSTIJKPlayerMulti1.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_VIDEO_RENDERING_START:");
                    break;
                case 700:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_VIDEO_TRACK_LAGGING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_START /*701*/:
                    NSTIJKPlayerMulti1.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_BUFFERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_END /*702*/:
                    NSTIJKPlayerMulti1.this.statusChange(6);
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_BUFFERING_END:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NETWORK_BANDWIDTH /*703*/:
                    ...
                    break;
                case 800:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_BAD_INTERLEAVING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE /*801*/:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_NOT_SEEKABLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_METADATA_UPDATE /*802*/:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_METADATA_UPDATE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_UNSUPPORTED_SUBTITLE /*901*/:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_UNSUPPORTED_SUBTITLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_SUBTITLE_TIMED_OUT /*902*/:
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_SUBTITLE_TIMED_OUT:");
                    break;
                case 10001:
                    int unused = NSTIJKPlayerMulti1.this.mVideoRotationDegree = i2;
                    String access$18002 = NSTIJKPlayerMulti1.this.TAG;
                    Log.d(access$18002, "MEDIA_INFO_VIDEO_ROTATION_CHANGED: " + i2);
                    if (NSTIJKPlayerMulti1.this.mRenderView != null) {
                        NSTIJKPlayerMulti1.this.mRenderView.setVideoRotation(i2);
                        break;
                    }
                    break;
                case 10002:
                    NSTIJKPlayerMulti1.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_AUDIO_RENDERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_OPEN_INPUT /*10005*/:
                    NSTIJKPlayerMulti1.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti1.this.TAG, "MEDIA_INFO_OPEN_INPUT:");
                    break;
            }
            return true;
        }
    ...
    IMediaPlayer.OnPreparedListener mPreparedListener = new IMediaPlayer.OnPreparedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass3 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnPreparedListener
        public void onPrepared(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti1.this.mCurrentState = 2;
            if (NSTIJKPlayerMulti1.this.mOnPreparedListener != null) {
                NSTIJKPlayerMulti1.this.mOnPreparedListener.onPrepared(NSTIJKPlayerMulti1.this.mMediaPlayer);
            }
            if (NSTIJKPlayerMulti1.this.mMediaController != null) {
                NSTIJKPlayerMulti1.this.mMediaController.setEnabled(true);
            }
            int unused2 = NSTIJKPlayerMulti1.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused3 = NSTIJKPlayerMulti1.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            if (NSTIJKPlayerMulti1.this.mVideoWidth == 0 || NSTIJKPlayerMulti1.this.mVideoHeight == 0) {
                if (NSTIJKPlayerMulti1.this.mTargetState == 3) {
                    NSTIJKPlayerMulti1.this.start();
                }
            } else if (NSTIJKPlayerMulti1.this.mRenderView != null) {
                NSTIJKPlayerMulti1.this.mRenderView.setVideoSize(NSTIJKPlayerMulti1.this.mVideoWidth, NSTIJKPlayerMulti1.this.mVideoHeight);
                NSTIJKPlayerMulti1.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerMulti1.this.mVideoSarNum, NSTIJKPlayerMulti1.this.mVideoSarDen);
                if ((!NSTIJKPlayerMulti1.this.mRenderView.shouldWaitForResize() || (NSTIJKPlayerMulti1.this.mSurfaceWidth == NSTIJKPlayerMulti1.this.mVideoWidth && NSTIJKPlayerMulti1.this.mSurfaceHeight == NSTIJKPlayerMulti1.this.mVideoHeight)) && NSTIJKPlayerMulti1.this.mTargetState == 3) {
                    NSTIJKPlayerMulti1.this.start();
                    if (NSTIJKPlayerMulti1.this.mMediaController != null) {
                        NSTIJKPlayerMulti1.this.mMediaController.show();
                    }
                }
            }
        }
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass8 */

        @Override // com.nst.yourname.view.ijkplayer.widget.media.IRenderView.IRenderCallback
        public void onSurfaceChanged(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2, int i3) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti1.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti1.this.TAG, "onSurfaceChanged: unmatched render callback\n");
                return;
            }
            int unused = NSTIJKPlayerMulti1.this.mSurfaceWidth = i2;
            int unused2 = NSTIJKPlayerMulti1.this.mSurfaceHeight = i3;
            boolean z = false;
            boolean z2 = NSTIJKPlayerMulti1.this.mTargetState == 3;
            if (!NSTIJKPlayerMulti1.this.mRenderView.shouldWaitForResize() || (NSTIJKPlayerMulti1.this.mVideoWidth == i2 && NSTIJKPlayerMulti1.this.mVideoHeight == i3)) {
                z = true;
            }
            if (NSTIJKPlayerMulti1.this.mMediaPlayer != null && z2 && z) {
                if (NSTIJKPlayerMulti1.this.mSeekWhenPrepared != 0) {
                    NSTIJKPlayerMulti1.this.seekTo(NSTIJKPlayerMulti1.this.mSeekWhenPrepared);
                }
                NSTIJKPlayerMulti1.this.start();
            }
        }
        ...
        public void onSurfaceCreated(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti1.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti1.this.TAG, "onSurfaceCreated: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti1.this.mSurfaceHolder = iSurfaceHolder;
            if (NSTIJKPlayerMulti1.this.mMediaPlayer != null) {
                NSTIJKPlayerMulti1.this.bindSurfaceHolder(NSTIJKPlayerMulti1.this.mMediaPlayer, iSurfaceHolder);
            } else {
                NSTIJKPlayerMulti1.this.openVideo();
            }
        }
        ...
        public void onSurfaceDestroyed(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti1.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti1.this.TAG, "onSurfaceDestroyed: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti1.this.mSurfaceHolder = null;
            NSTIJKPlayerMulti1.this.releaseWithoutStop();
        }
    };
    public int mSeekWhenPrepared;
    private Settings mSettings;
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener = new IMediaPlayer.OnVideoSizeChangedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass2 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnVideoSizeChangedListener
        public void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i, int i2, int i3, int i4) {
            int unused = NSTIJKPlayerMulti1.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused2 = NSTIJKPlayerMulti1.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            int unused3 = NSTIJKPlayerMulti1.this.mVideoSarNum = iMediaPlayer.getVideoSarNum();
            int unused4 = NSTIJKPlayerMulti1.this.mVideoSarDen = iMediaPlayer.getVideoSarDen();
            if (NSTIJKPlayerMulti1.this.mVideoWidth != 0 && NSTIJKPlayerMulti1.this.mVideoHeight != 0) {
                if (NSTIJKPlayerMulti1.this.mRenderView != null) {
                    NSTIJKPlayerMulti1.this.mRenderView.setVideoSize(NSTIJKPlayerMulti1.this.mVideoWidth, NSTIJKPlayerMulti1.this.mVideoHeight);
                    NSTIJKPlayerMulti1.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerMulti1.this.mVideoSarNum, NSTIJKPlayerMulti1.this.mVideoSarDen);
    ...
    public NSTIJKPlayerMulti1(Context context2) {
        super(context2);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti1(Context context2, AttributeSet attributeSet) {
        super(context2, attributeSet);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti1(Context context2, AttributeSet attributeSet, int i) {
    ...
    public void setActivity(Activity activity, NSTIJKPlayerMulti1 nSTIJKPlayerMulti1) {
        this.mActivity = activity;
        this.mVideoView1 = nSTIJKPlayerMulti1;
    ...
    private void showStatus(String str) {
        this.$.id(R.id.video_view_1).gone();
    ...
    public void statusChange(int i) {
        ...
        if (i == -1) {
            ...
            this.handler.postDelayed(new Runnable() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti1.AnonymousClass1 */

                public void run() {
                    NSTIJKPlayerMulti1.this.retryCount++;
                    NSTIJKPlayerMulti1.this.hideAll();
                    Utils.showToast(NSTIJKPlayerMulti1.this.mActivity, NSTIJKPlayerMulti1.this.mActivity.getResources().getString(R.string.play_back_error) + " (" + NSTIJKPlayerMulti1.this.retryCount + "/" + NSTIJKPlayerMulti1.this.maxRetry + ")");
                    NSTIJKPlayerMulti1.this.openVideo();
                    NSTIJKPlayerMulti1.this.start();
                }
            }, 3000);
        } else if (i == 1) {
            this.$.id(R.id.app_video_loading_1).visible();
        } else if (i == 3) {
            this.retryCount = 0;
            ...
            this.$.id(R.id.app_video_loading_1).gone();
        } else if (i == 6) {
            this.retryCount = 0;
            this.$.id(R.id.app_video_status).gone();
            this.$.id(R.id.video_view_1).visible();
            this.$.id(R.id.exo_play).gone();
            this.$.id(R.id.exo_pause).visible();
            this.$.id(R.id.app_video_loading_1).gone();
        } else if (i == 2) {
            ...
            this.$.id(R.id.exo_pause).visible();
            this.$.id(R.id.app_video_loading_1).gone();
            if (!this.mActivity.findViewById(R.id.app_video_box_1).isFocusable()) {
                mutePlayer();
            }
        } else if (i == 4) {
