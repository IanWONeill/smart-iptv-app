...
public class NSTIJKPlayerMulti2 extends FrameLayout implements MediaController.MediaPlayerControl {
    ...
    private Query $;
    Handler EPGHandler;
    public String TAG = "NSTIJKPlayerMulti2";
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new IMediaPlayer.OnBufferingUpdateListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass7 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnBufferingUpdateListener
        public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i) {
            int unused = NSTIJKPlayerMulti2.this.mCurrentBufferPercentage = i;
        }
    };
    ...
    private IMediaPlayer.OnCompletionListener mCompletionListener = new IMediaPlayer.OnCompletionListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass4 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnCompletionListener
        public void onCompletion(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti2.this.mCurrentState = 5;
            int unused2 = NSTIJKPlayerMulti2.this.mTargetState = 5;
            if (NSTIJKPlayerMulti2.this.mMediaController != null) {
                NSTIJKPlayerMulti2.this.mMediaController.hide();
            }
            NSTIJKPlayerMulti2.this.statusChange(-1);
            if (NSTIJKPlayerMulti2.this.mOnCompletionListener != null) {
                NSTIJKPlayerMulti2.this.mOnCompletionListener.onCompletion(NSTIJKPlayerMulti2.this.mMediaPlayer);
            }
        }
    };
    ...
    private IMediaPlayer.OnErrorListener mErrorListener = new IMediaPlayer.OnErrorListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass6 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnErrorListener
        public boolean onError(IMediaPlayer iMediaPlayer, int i, int i2) {
            String access$1800 = NSTIJKPlayerMulti2.this.TAG;
            Log.d(access$1800, "Error: " + i + "," + i2);
            int unused = NSTIJKPlayerMulti2.this.mCurrentState = -1;
            int unused2 = NSTIJKPlayerMulti2.this.mTargetState = -1;
            if (NSTIJKPlayerMulti2.this.mMediaController != null) {
                NSTIJKPlayerMulti2.this.mMediaController.hide();
            }
            NSTIJKPlayerMulti2.this.statusChange(-1);
            return (NSTIJKPlayerMulti2.this.mOnErrorListener == null || NSTIJKPlayerMulti2.this.mOnErrorListener.onError(NSTIJKPlayerMulti2.this.mMediaPlayer, i, i2)) ? true : true;
        }
    };
    private Map<String, String> mHeaders;
    private IMediaPlayer.OnInfoListener mInfoListener = new IMediaPlayer.OnInfoListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass5 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnInfoListener
        public boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i2) {
            if (NSTIJKPlayerMulti2.this.mOnInfoListener != null) {
                NSTIJKPlayerMulti2.this.mOnInfoListener.onInfo(iMediaPlayer, i, i2);
            }
            switch (i) {
                case 3:
                    NSTIJKPlayerMulti2.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_VIDEO_RENDERING_START:");
                    break;
                case 700:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_VIDEO_TRACK_LAGGING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_START /*701*/:
                    NSTIJKPlayerMulti2.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_BUFFERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_END /*702*/:
                    NSTIJKPlayerMulti2.this.statusChange(6);
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_BUFFERING_END:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NETWORK_BANDWIDTH /*703*/:
                    ...
                    break;
                case 800:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_BAD_INTERLEAVING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE /*801*/:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_NOT_SEEKABLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_METADATA_UPDATE /*802*/:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_METADATA_UPDATE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_UNSUPPORTED_SUBTITLE /*901*/:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_UNSUPPORTED_SUBTITLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_SUBTITLE_TIMED_OUT /*902*/:
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_SUBTITLE_TIMED_OUT:");
                    break;
                case 10001:
                    int unused = NSTIJKPlayerMulti2.this.mVideoRotationDegree = i2;
                    String access$18002 = NSTIJKPlayerMulti2.this.TAG;
                    Log.d(access$18002, "MEDIA_INFO_VIDEO_ROTATION_CHANGED: " + i2);
                    if (NSTIJKPlayerMulti2.this.mRenderView != null) {
                        NSTIJKPlayerMulti2.this.mRenderView.setVideoRotation(i2);
                        break;
                    }
                    break;
                case 10002:
                    NSTIJKPlayerMulti2.this.statusChange(2);
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_AUDIO_RENDERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_OPEN_INPUT /*10005*/:
                    NSTIJKPlayerMulti2.this.statusChange(1);
                    Log.d(NSTIJKPlayerMulti2.this.TAG, "MEDIA_INFO_OPEN_INPUT:");
                    break;
            }
            return true;
        }
    ...
    IMediaPlayer.OnPreparedListener mPreparedListener = new IMediaPlayer.OnPreparedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass3 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnPreparedListener
        public void onPrepared(IMediaPlayer iMediaPlayer) {
            int unused = NSTIJKPlayerMulti2.this.mCurrentState = 2;
            if (NSTIJKPlayerMulti2.this.mOnPreparedListener != null) {
                NSTIJKPlayerMulti2.this.mOnPreparedListener.onPrepared(NSTIJKPlayerMulti2.this.mMediaPlayer);
            }
            if (NSTIJKPlayerMulti2.this.mMediaController != null) {
                NSTIJKPlayerMulti2.this.mMediaController.setEnabled(true);
            }
            int unused2 = NSTIJKPlayerMulti2.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused3 = NSTIJKPlayerMulti2.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            if (NSTIJKPlayerMulti2.this.mVideoWidth == 0 || NSTIJKPlayerMulti2.this.mVideoHeight == 0) {
                if (NSTIJKPlayerMulti2.this.mTargetState == 3) {
                    NSTIJKPlayerMulti2.this.start();
                }
            } else if (NSTIJKPlayerMulti2.this.mRenderView != null) {
                NSTIJKPlayerMulti2.this.mRenderView.setVideoSize(NSTIJKPlayerMulti2.this.mVideoWidth, NSTIJKPlayerMulti2.this.mVideoHeight);
                NSTIJKPlayerMulti2.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerMulti2.this.mVideoSarNum, NSTIJKPlayerMulti2.this.mVideoSarDen);
                if ((!NSTIJKPlayerMulti2.this.mRenderView.shouldWaitForResize() || (NSTIJKPlayerMulti2.this.mSurfaceWidth == NSTIJKPlayerMulti2.this.mVideoWidth && NSTIJKPlayerMulti2.this.mSurfaceHeight == NSTIJKPlayerMulti2.this.mVideoHeight)) && NSTIJKPlayerMulti2.this.mTargetState == 3) {
                    NSTIJKPlayerMulti2.this.start();
                    if (NSTIJKPlayerMulti2.this.mMediaController != null) {
                        NSTIJKPlayerMulti2.this.mMediaController.show();
                    }
                }
            }
        }
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass8 */

        @Override // com.nst.yourname.view.ijkplayer.widget.media.IRenderView.IRenderCallback
        public void onSurfaceChanged(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2, int i3) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti2.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti2.this.TAG, "onSurfaceChanged: unmatched render callback\n");
                return;
            }
            int unused = NSTIJKPlayerMulti2.this.mSurfaceWidth = i2;
            int unused2 = NSTIJKPlayerMulti2.this.mSurfaceHeight = i3;
            boolean z = false;
            boolean z2 = NSTIJKPlayerMulti2.this.mTargetState == 3;
            if (!NSTIJKPlayerMulti2.this.mRenderView.shouldWaitForResize() || (NSTIJKPlayerMulti2.this.mVideoWidth == i2 && NSTIJKPlayerMulti2.this.mVideoHeight == i3)) {
                z = true;
            }
            if (NSTIJKPlayerMulti2.this.mMediaPlayer != null && z2 && z) {
                if (NSTIJKPlayerMulti2.this.mSeekWhenPrepared != 0) {
                    NSTIJKPlayerMulti2.this.seekTo(NSTIJKPlayerMulti2.this.mSeekWhenPrepared);
                }
                NSTIJKPlayerMulti2.this.start();
            }
        }
        ...
        public void onSurfaceCreated(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti2.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti2.this.TAG, "onSurfaceCreated: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti2.this.mSurfaceHolder = iSurfaceHolder;
            if (NSTIJKPlayerMulti2.this.mMediaPlayer != null) {
                NSTIJKPlayerMulti2.this.bindSurfaceHolder(NSTIJKPlayerMulti2.this.mMediaPlayer, iSurfaceHolder);
            } else {
                NSTIJKPlayerMulti2.this.openVideo();
            }
        }
        ...
        public void onSurfaceDestroyed(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerMulti2.this.mRenderView) {
                Log.e(NSTIJKPlayerMulti2.this.TAG, "onSurfaceDestroyed: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerMulti2.this.mSurfaceHolder = null;
            NSTIJKPlayerMulti2.this.releaseWithoutStop();
        }
    };
    public int mSeekWhenPrepared;
    private Settings mSettings;
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener = new IMediaPlayer.OnVideoSizeChangedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass2 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnVideoSizeChangedListener
        public void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i, int i2, int i3, int i4) {
            int unused = NSTIJKPlayerMulti2.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused2 = NSTIJKPlayerMulti2.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            int unused3 = NSTIJKPlayerMulti2.this.mVideoSarNum = iMediaPlayer.getVideoSarNum();
            int unused4 = NSTIJKPlayerMulti2.this.mVideoSarDen = iMediaPlayer.getVideoSarDen();
            if (NSTIJKPlayerMulti2.this.mVideoWidth != 0 && NSTIJKPlayerMulti2.this.mVideoHeight != 0) {
                if (NSTIJKPlayerMulti2.this.mRenderView != null) {
                    NSTIJKPlayerMulti2.this.mRenderView.setVideoSize(NSTIJKPlayerMulti2.this.mVideoWidth, NSTIJKPlayerMulti2.this.mVideoHeight);
                    NSTIJKPlayerMulti2.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerMulti2.this.mVideoSarNum, NSTIJKPlayerMulti2.this.mVideoSarDen);
    ...
    public NSTIJKPlayerMulti2(Context context2) {
        super(context2);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti2(Context context2, AttributeSet attributeSet) {
        super(context2, attributeSet);
        initVideoView(context2);
    }

    public NSTIJKPlayerMulti2(Context context2, AttributeSet attributeSet, int i) {
    ...
    public void setActivity(Activity activity, NSTIJKPlayerMulti2 nSTIJKPlayerMulti2) {
        this.mActivity = activity;
        this.mVideoView2 = nSTIJKPlayerMulti2;
    ...
    public void openVideo() {
        if (this.mUri != null && this.mSurfaceHolder != null) {
            ...
            this.$.id(R.id.app_video_status_2).gone();
            try {
    ...
    private void showStatus(String str) {
        this.$.id(R.id.video_view_2).gone();
        this.$.id(R.id.app_video_status_2).visible();
        this.$.id(R.id.app_video_status_text_2).text(str);
    }
    ...
    public void statusChange(int i) {
        ...
        if (i == -1) {
            ...
            this.handler.postDelayed(new Runnable() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerMulti2.AnonymousClass1 */

                public void run() {
                    NSTIJKPlayerMulti2.this.retryCount++;
                    NSTIJKPlayerMulti2.this.hideAll();
                    Utils.showToast(NSTIJKPlayerMulti2.this.mActivity, NSTIJKPlayerMulti2.this.mActivity.getResources().getString(R.string.play_back_error) + " (" + NSTIJKPlayerMulti2.this.retryCount + "/" + NSTIJKPlayerMulti2.this.maxRetry + ")");
                    NSTIJKPlayerMulti2.this.openVideo();
                    NSTIJKPlayerMulti2.this.start();
                }
            }, 3000);
        } else if (i == 1) {
            this.$.id(R.id.app_video_loading_2).visible();
        } else if (i == 3) {
            this.retryCount = 0;
            ...
            this.$.id(R.id.app_video_loading_2).gone();
        } else if (i == 6) {
            this.retryCount = 0;
            this.$.id(R.id.app_video_status_2).gone();
            this.$.id(R.id.video_view_2).visible();
            this.$.id(R.id.exo_play).gone();
            this.$.id(R.id.exo_pause).visible();
            this.$.id(R.id.app_video_loading_2).gone();
        } else if (i == 2) {
            ...
            this.$.id(R.id.exo_pause).visible();
            this.$.id(R.id.app_video_loading_2).gone();
            if (!this.mActivity.findViewById(R.id.app_video_box_2).isFocusable()) {
                mutePlayer();
            }
        } else if (i == 4) {
    ...
    public void hideTitleBarAndFooter() {
        this.$.id(R.id.app_video_top_box_2).gone();
        this.$.id(R.id.controls_2).gone();
