    ...
    public boolean onOptionsItemSelected(MenuItem menuItem) {
        ...
        if (itemId == R.id.action_logout1 && this.context != null) {
            new AlertDialog.Builder(this.context, R.style.AlertDialogCustom).setTitle(getResources().getString(R.string.logout_title)).setMessage(getResources().getString(R.string.logout_message)).setPositiveButton(getResources().getString(R.string.yes), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass2 */

                public void onClick(DialogInterface dialogInterface, int i) {
                    Utils.logoutUser(LiveStreamsFragment.this.context);
                }
            }).setNegativeButton(getResources().getString(R.string.no), new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass1 */
        ...
        if (itemId == R.id.action_search) {
            ...
            this.searchView.setOnQueryTextListener(new SearchView.OnQueryTextListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass3 */
            ...
            builder.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass4 */
            ...
            builder.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass5 */
            ...
            builder2.setPositiveButton("YES", new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass6 */
            ...
            builder2.setNegativeButton("NO", new DialogInterface.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass7 */
    ...
    private void showSortPopup(Activity activity) {
        try {
            ...
            button2.setOnClickListener(new View.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass8 */
            ...
            button.setOnClickListener(new View.OnClickListener() {
                /* class com.nst.yourname.view.fragment.LiveStreamsFragment.AnonymousClass9 */
                ...
                public void onClick(View view) {
                    ...
                    if (radioButton.getText().toString().equals(LiveStreamsFragment.this.getResources().getString(R.string.sort_last_added))) {
                        ...
                        LiveStreamsFragment.this.SharedPreferencesSortEditor.putString(AppConst.LOGIN_PREF_SORT, "2");
                        LiveStreamsFragment.this.SharedPreferencesSortEditor.commit();
                    ...
                    SharedPreferences unused = LiveStreamsFragment.this.pref = LiveStreamsFragment.this.getActivity().getSharedPreferences("listgridview", 0);
                    SharedPreferences.Editor unused2 = LiveStreamsFragment.this.editor = LiveStreamsFragment.this.pref.edit();
    ...
    private void setUpdatabaseResult() {
        try {
            ...
            if (this.context != null) {
                ...
                ArrayList<LiveStreamsDBModel> allLiveStreasWithCategoryId = liveStreamDBHandler2.getAllLiveStreasWithCategoryId(this.getActiveLiveStreamCategoryId, "live");
