...
public class NSTIJKPlayerVOD extends FrameLayout implements MediaController.MediaPlayerControl, VodInterface {
    ...
    public Query $;
    public String TAG = "NSTIJKPlayerVOD";
    ...
    public Handler handler1 = new Handler(Looper.getMainLooper()) {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass4 */

        public void handleMessage(Message message) {
            switch (message.what) {
                case 1:
                    int unused = NSTIJKPlayerVOD.this.setProgress();
                    if (!NSTIJKPlayerVOD.this.isDragging && NSTIJKPlayerVOD.this.isShowing) {
                        NSTIJKPlayerVOD.this.handler1.sendMessageDelayed(NSTIJKPlayerVOD.this.handler1.obtainMessage(1), 300);
                        NSTIJKPlayerVOD.this.updatePausePlay();
                        return;
                    }
                    return;
                case 2:
                    NSTIJKPlayerVOD.this.hide(false);
                    return;
                case 3:
                    if (NSTIJKPlayerVOD.this.newPosition >= 0) {
                        NSTIJKPlayerVOD.this.mVideoView.seekTo((int) NSTIJKPlayerVOD.this.newPosition);
                        long unused2 = NSTIJKPlayerVOD.this.newPosition = -1;
                        return;
                    }
                    return;
                case 4:
                    NSTIJKPlayerVOD.this.$.id(R.id.app_video_volume_box).gone();
                    NSTIJKPlayerVOD.this.$.id(R.id.app_video_brightness_box).gone();
                    NSTIJKPlayerVOD.this.$.id(R.id.app_video_fastForward_box).gone();
                    return;
                default:
                    return;
            }
    ...
    private IMediaPlayer.OnBufferingUpdateListener mBufferingUpdateListener = new IMediaPlayer.OnBufferingUpdateListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass17 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnBufferingUpdateListener
        public void onBufferingUpdate(IMediaPlayer iMediaPlayer, int i) {
            int unused = NSTIJKPlayerVOD.this.mCurrentBufferPercentage = i;
        }
    };
    ...
    private IMediaPlayer.OnCompletionListener mCompletionListener = new IMediaPlayer.OnCompletionListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass8 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnCompletionListener
        public void onCompletion(IMediaPlayer iMediaPlayer) {
            int i;
            int unused = NSTIJKPlayerVOD.this.mCurrentState = 5;
            int unused2 = NSTIJKPlayerVOD.this.mTargetState = 5;
            if (NSTIJKPlayerVOD.this.mMediaController != null) {
                NSTIJKPlayerVOD.this.mMediaController.hide();
            }
            if (NSTIJKPlayerVOD.this.mActivity == null || !SharepreferenceDBHandler.getisAutoPlayVideos(NSTIJKPlayerVOD.this.mActivity)) {
                NSTIJKPlayerVOD.this.show(NSTIJKPlayerVOD.this.defaultTimeout);
            } else {
                int currentWindowIndex = VideoInfo.getInstance().getCurrentWindowIndex();
                String type = SharepreferenceDBHandler.getType(NSTIJKPlayerVOD.this.mActivity);
                int i2 = 0;
                if (type.equals("movies")) {
                    ...
                    if (arrayList.size() <= 1 || i3 > arrayList.size() - 1) {
                        ...
                        try {
                            i = Integer.parseInt(((LiveStreamsDBModel) arrayList.get(i3)).getStreamId());
                        } catch (Exception unused3) {
                            i = 0;
                        }
                        if (!(NSTIJKPlayerVOD.this.appType == null || NSTIJKPlayerVOD.this.appType.equals(AppConst.TYPE_M3U) || i == -1 || i == 0)) {
                            NSTIJKPlayerVOD.this.loginPreferencesAfterLogin = NSTIJKPlayerVOD.this.mAppContext.getSharedPreferences(AppConst.LOGIN_SHARED_PREFERENCE, 0);
                            NSTIJKPlayerVOD.this.vodPresenter.vodInfo(NSTIJKPlayerVOD.this.loginPreferencesAfterLogin.getString("username", ""), NSTIJKPlayerVOD.this.loginPreferencesAfterLogin.getString("password", ""), i);
                        }
                        NSTIJKPlayerVOD.this.setListData(name);
                    }
                    ...
                    if (currentWindowIndex != episodeList.size() - 1) {
                        i2 = currentWindowIndex + 1;
                    }
                    if (episodeList.size() <= 1 || i2 > episodeList.size() - 1) {
                        NSTIJKPlayerVOD.this.show(NSTIJKPlayerVOD.this.defaultTimeout);
                    } else {
                        String title = episodeList.get(i2).getTitle();
                        if (episodeList.get(i2).getMovieImage() != null) {
                            try {
                                Glide.with(NSTIJKPlayerVOD.this.mAppContext.getApplicationContext()).load(episodeList.get(i2).getMovieImage()).asBitmap().into(new SimpleTarget<Bitmap>() {
                                    /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass8.AnonymousClass1 */

                                    public void onResourceReady(Bitmap bitmap, GlideAnimation glideAnimation) {
                                        BitmapDrawable bitmapDrawable = new BitmapDrawable(bitmap);
                                        if (NSTIJKPlayerVOD.this.next_background != null) {
                                            NSTIJKPlayerVOD.this.next_background.setBackground(bitmapDrawable);
                                        }
                                    }
                                });
                        ...
                        NSTIJKPlayerVOD.this.setListData(title);
                    }
                } else if (type.equals("recording") || type.equals("catch_up")) {
                    NSTIJKPlayerVOD.this.show(NSTIJKPlayerVOD.this.defaultTimeout);
                    NSTIJKPlayerVOD.this.openVideo();
                    NSTIJKPlayerVOD.this.start();
                }
            }
            if (NSTIJKPlayerVOD.this.mOnCompletionListener != null) {
                NSTIJKPlayerVOD.this.mOnCompletionListener.onCompletion(NSTIJKPlayerVOD.this.mMediaPlayer);
            }
        }
    };
    ...
    private IMediaPlayer.OnErrorListener mErrorListener = new IMediaPlayer.OnErrorListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass16 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnErrorListener
        public boolean onError(IMediaPlayer iMediaPlayer, int i, int i2) {
            String access$4300 = NSTIJKPlayerVOD.this.TAG;
            Log.d(access$4300, "Error: " + i + "," + i2);
            int unused = NSTIJKPlayerVOD.this.mCurrentState = -1;
            int unused2 = NSTIJKPlayerVOD.this.mTargetState = -1;
            if (NSTIJKPlayerVOD.this.mMediaController != null) {
                NSTIJKPlayerVOD.this.mMediaController.hide();
            }
            NSTIJKPlayerVOD.this.statusChange(-1);
            return (NSTIJKPlayerVOD.this.mOnErrorListener == null || NSTIJKPlayerVOD.this.mOnErrorListener.onError(NSTIJKPlayerVOD.this.mMediaPlayer, i, i2)) ? true : true;
        }
    };
    ...
    private IMediaPlayer.OnInfoListener mInfoListener = new IMediaPlayer.OnInfoListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass15 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnInfoListener
        public boolean onInfo(IMediaPlayer iMediaPlayer, int i, int i2) {
            if (NSTIJKPlayerVOD.this.mOnInfoListener != null) {
                NSTIJKPlayerVOD.this.mOnInfoListener.onInfo(iMediaPlayer, i, i2);
            }
            switch (i) {
                case 3:
                    NSTIJKPlayerVOD.this.statusChange(2);
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_VIDEO_RENDERING_START:");
                    break;
                case 700:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_VIDEO_TRACK_LAGGING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_START /*701*/:
                    NSTIJKPlayerVOD.this.statusChange(1);
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_BUFFERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_BUFFERING_END /*702*/:
                    NSTIJKPlayerVOD.this.statusChange(6);
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_BUFFERING_END:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NETWORK_BANDWIDTH /*703*/:
                    String access$4300 = NSTIJKPlayerVOD.this.TAG;
                    Log.d(access$4300, "MEDIA_INFO_NETWORK_BANDWIDTH: " + i2);
                    break;
                case 800:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_BAD_INTERLEAVING:");
                    break;
                case IMediaPlayer.MEDIA_INFO_NOT_SEEKABLE /*801*/:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_NOT_SEEKABLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_METADATA_UPDATE /*802*/:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_METADATA_UPDATE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_UNSUPPORTED_SUBTITLE /*901*/:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_UNSUPPORTED_SUBTITLE:");
                    break;
                case IMediaPlayer.MEDIA_INFO_SUBTITLE_TIMED_OUT /*902*/:
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_SUBTITLE_TIMED_OUT:");
                    break;
                case 10001:
                    int unused = NSTIJKPlayerVOD.this.mVideoRotationDegree = i2;
                    String access$43002 = NSTIJKPlayerVOD.this.TAG;
                    Log.d(access$43002, "MEDIA_INFO_VIDEO_ROTATION_CHANGED: " + i2);
                    if (NSTIJKPlayerVOD.this.mRenderView != null) {
                        NSTIJKPlayerVOD.this.mRenderView.setVideoRotation(i2);
                        break;
                    }
                    break;
                case 10002:
                    NSTIJKPlayerVOD.this.statusChange(2);
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_AUDIO_RENDERING_START:");
                    break;
                case IMediaPlayer.MEDIA_INFO_OPEN_INPUT /*10005*/:
                    NSTIJKPlayerVOD.this.statusChange(1);
                    Log.d(NSTIJKPlayerVOD.this.TAG, "MEDIA_INFO_OPEN_INPUT:");
                    break;
            }
            return true;
        }
    ...
    private IMediaPlayer.OnTimedTextListener mOnTimedTextListener = new IMediaPlayer.OnTimedTextListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass19 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnTimedTextListener
        public void onTimedText(IMediaPlayer iMediaPlayer, IjkTimedText ijkTimedText) {
            if (ijkTimedText == null) {
                NSTIJKPlayerVOD.this.subtitleDisplay.setVisibility(8);
                return;
            }
            String replace = ijkTimedText.getText().replace("{\\b1}", "").replace("{\\b0}", "").replace("{\\i1}", "").replace("{\\i0}", "").replace("{\\c}", "");
            SharedPreferences unused = NSTIJKPlayerVOD.this.loginPreferencesAfterLoginSubtitleSize = NSTIJKPlayerVOD.this.mAppContext.getSharedPreferences(AppConst.LOGIN_PREF_SUB_FONT_SIZE, 0);
            try {
                NSTIJKPlayerVOD.this.subtitleDisplay.setTextSize(2, Float.parseFloat(NSTIJKPlayerVOD.this.loginPreferencesAfterLoginSubtitleSize.getString(AppConst.LOGIN_PREF_SUB_FONT_SIZE, "20")));
            } catch (Exception unused2) {
            }
            NSTIJKPlayerVOD.this.subtitleDisplay.setVisibility(0);
            NSTIJKPlayerVOD.this.subtitleDisplay.setText(replace);
        }
    };
    public long mPrepareEndTime = 0;
    private long mPrepareStartTime = 0;
    IMediaPlayer.OnPreparedListener mPreparedListener = new IMediaPlayer.OnPreparedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass7 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnPreparedListener
        public void onPrepared(IMediaPlayer iMediaPlayer) {
            long unused = NSTIJKPlayerVOD.this.mPrepareEndTime = System.currentTimeMillis();
            int unused2 = NSTIJKPlayerVOD.this.mCurrentState = 2;
            if (NSTIJKPlayerVOD.this.mOnPreparedListener != null) {
                NSTIJKPlayerVOD.this.mOnPreparedListener.onPrepared(NSTIJKPlayerVOD.this.mMediaPlayer);
            }
            if (NSTIJKPlayerVOD.this.mMediaController != null) {
                NSTIJKPlayerVOD.this.mMediaController.setEnabled(true);
            }
            int unused3 = NSTIJKPlayerVOD.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused4 = NSTIJKPlayerVOD.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            int access$2900 = NSTIJKPlayerVOD.this.mSeekWhenPrepared;
            if (access$2900 != 0) {
                NSTIJKPlayerVOD.this.seekTo(access$2900);
            }
            if (NSTIJKPlayerVOD.this.mVideoWidth == 0 || NSTIJKPlayerVOD.this.mVideoHeight == 0) {
                if (NSTIJKPlayerVOD.this.mTargetState == 3) {
                    NSTIJKPlayerVOD.this.start();
                }
            } else if (NSTIJKPlayerVOD.this.mRenderView != null) {
                NSTIJKPlayerVOD.this.mRenderView.setVideoSize(NSTIJKPlayerVOD.this.mVideoWidth, NSTIJKPlayerVOD.this.mVideoHeight);
                NSTIJKPlayerVOD.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerVOD.this.mVideoSarNum, NSTIJKPlayerVOD.this.mVideoSarDen);
                if (NSTIJKPlayerVOD.this.mRenderView.shouldWaitForResize() && (NSTIJKPlayerVOD.this.mSurfaceWidth != NSTIJKPlayerVOD.this.mVideoWidth || NSTIJKPlayerVOD.this.mSurfaceHeight != NSTIJKPlayerVOD.this.mVideoHeight)) {
                    return;
                }
                if (NSTIJKPlayerVOD.this.mTargetState == 3) {
                    NSTIJKPlayerVOD.this.start();
                    if (NSTIJKPlayerVOD.this.mMediaController != null) {
                        NSTIJKPlayerVOD.this.mMediaController.show();
                    }
                } else if (NSTIJKPlayerVOD.this.isPlaying()) {
                } else {
                    if ((access$2900 != 0 || NSTIJKPlayerVOD.this.getCurrentPosition() > 0) && NSTIJKPlayerVOD.this.mMediaController != null) {
                        NSTIJKPlayerVOD.this.mMediaController.show(0);
                    }
                }
            }
        }
    ...
    IRenderView.IRenderCallback mSHCallback = new IRenderView.IRenderCallback() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass20 */

        @Override // com.nst.yourname.view.ijkplayer.widget.media.IRenderView.IRenderCallback
        public void onSurfaceChanged(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2, int i3) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerVOD.this.mRenderView) {
                Log.e(NSTIJKPlayerVOD.this.TAG, "onSurfaceChanged: unmatched render callback\n");
                return;
            }
            int unused = NSTIJKPlayerVOD.this.mSurfaceWidth = i2;
            int unused2 = NSTIJKPlayerVOD.this.mSurfaceHeight = i3;
            boolean z = false;
            boolean z2 = NSTIJKPlayerVOD.this.mTargetState == 3;
            if (!NSTIJKPlayerVOD.this.mRenderView.shouldWaitForResize() || (NSTIJKPlayerVOD.this.mVideoWidth == i2 && NSTIJKPlayerVOD.this.mVideoHeight == i3)) {
                z = true;
            }
            if (NSTIJKPlayerVOD.this.mMediaPlayer != null && z2 && z) {
                if (NSTIJKPlayerVOD.this.mSeekWhenPrepared != 0) {
                    NSTIJKPlayerVOD.this.seekTo(NSTIJKPlayerVOD.this.mSeekWhenPrepared);
                }
                NSTIJKPlayerVOD.this.start();
            }
        }
        ...
        public void onSurfaceCreated(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder, int i, int i2) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerVOD.this.mRenderView) {
                Log.e(NSTIJKPlayerVOD.this.TAG, "onSurfaceCreated: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerVOD.this.mSurfaceHolder = iSurfaceHolder;
            if (NSTIJKPlayerVOD.this.mMediaPlayer != null) {
                NSTIJKPlayerVOD.this.bindSurfaceHolder(NSTIJKPlayerVOD.this.mMediaPlayer, iSurfaceHolder);
            } else {
                NSTIJKPlayerVOD.this.openVideo();
            }
        }
        ...
        public void onSurfaceDestroyed(@NonNull IRenderView.ISurfaceHolder iSurfaceHolder) {
            if (iSurfaceHolder.getRenderView() != NSTIJKPlayerVOD.this.mRenderView) {
                Log.e(NSTIJKPlayerVOD.this.TAG, "onSurfaceDestroyed: unmatched render callback\n");
                return;
            }
            IRenderView.ISurfaceHolder unused = NSTIJKPlayerVOD.this.mSurfaceHolder = null;
            NSTIJKPlayerVOD.this.releaseWithoutStop();
        }
    };
    private IMediaPlayer.OnSeekCompleteListener mSeekCompleteListener = new IMediaPlayer.OnSeekCompleteListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass18 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnSeekCompleteListener
        public void onSeekComplete(IMediaPlayer iMediaPlayer) {
            long unused = NSTIJKPlayerVOD.this.mSeekEndTime = System.currentTimeMillis();
        }
    };
    ...
    IMediaPlayer.OnVideoSizeChangedListener mSizeChangedListener = new IMediaPlayer.OnVideoSizeChangedListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass6 */

        @Override // tv.danmaku.ijk.media.player.IMediaPlayer.OnVideoSizeChangedListener
        public void onVideoSizeChanged(IMediaPlayer iMediaPlayer, int i, int i2, int i3, int i4) {
            int unused = NSTIJKPlayerVOD.this.mVideoWidth = iMediaPlayer.getVideoWidth();
            int unused2 = NSTIJKPlayerVOD.this.mVideoHeight = iMediaPlayer.getVideoHeight();
            int unused3 = NSTIJKPlayerVOD.this.mVideoSarNum = iMediaPlayer.getVideoSarNum();
            int unused4 = NSTIJKPlayerVOD.this.mVideoSarDen = iMediaPlayer.getVideoSarDen();
            if (NSTIJKPlayerVOD.this.mVideoWidth != 0 && NSTIJKPlayerVOD.this.mVideoHeight != 0) {
                if (NSTIJKPlayerVOD.this.mRenderView != null) {
                    NSTIJKPlayerVOD.this.mRenderView.setVideoSize(NSTIJKPlayerVOD.this.mVideoWidth, NSTIJKPlayerVOD.this.mVideoHeight);
                    NSTIJKPlayerVOD.this.mRenderView.setVideoSampleAspectRatio(NSTIJKPlayerVOD.this.mVideoSarNum, NSTIJKPlayerVOD.this.mVideoSarDen);
    ...
    protected final OnClickListener onClickListener = new OnClickListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass13 */

        public void onClick(View view) {
            if (view.getId() == R.id.fabbutton_ring || view.getId() == R.id.ll_determinate) {
                NSTIJKPlayerVOD.this.playNextEpisode();
            } else if (view.getId() == R.id.cancel_autoplay) {
                NSTIJKPlayerVOD.this.hideAutoPlayScreen();
            }
        }
    };
    ...
    private SeriesRecentWatchDatabase recentWatchDatabase1;
    ...
    private final SeekBar.OnSeekBarChangeListener seekListener = new SeekBar.OnSeekBarChangeListener() {
        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass2 */

        public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
            if (z && NSTIJKPlayerVOD.this.mMediaPlayer != null) {
                NSTIJKPlayerVOD.this.$.id(R.id.app_video_status).gone();
                double duration = (double) NSTIJKPlayerVOD.this.mVideoView.getDuration();
                double d = (double) i;
                Double.isNaN(d);
                Double.isNaN(duration);
                int i2 = (int) (duration * ((d * 1.0d) / 1000.0d));
                generateTime((long) i2);
                if (NSTIJKPlayerVOD.this.instantSeeking) {
                    NSTIJKPlayerVOD.this.mVideoView.seekTo(i2);
                }
                TextView access$400 = NSTIJKPlayerVOD.this.txtDisplay;
                access$400.setText(NSTIJKPlayerVOD.this.stringForTime(NSTIJKPlayerVOD.this.mVideoView.getCurrentPosition()) + "/" + NSTIJKPlayerVOD.this.stringForTime(NSTIJKPlayerVOD.this.mVideoView.getDuration()));
            }
        }
        ...
        public void onStartTrackingTouch(SeekBar seekBar) {
            NSTIJKPlayerVOD.this.isDragging = true;
            NSTIJKPlayerVOD.this.show(DateTimeConstants.MILLIS_PER_HOUR);
            NSTIJKPlayerVOD.this.handler1.removeMessages(1);
            if (NSTIJKPlayerVOD.this.instantSeeking) {
                NSTIJKPlayerVOD.this.audioManager.setStreamMute(3, true);
            }
        }
        ...
        public void onStopTrackingTouch(SeekBar seekBar) {
            if (NSTIJKPlayerVOD.this.mMediaPlayer != null) {
                if (!NSTIJKPlayerVOD.this.instantSeeking) {
                    NSTIJKPlayerVOD access$200 = NSTIJKPlayerVOD.this.mVideoView;
                    double duration = (double) NSTIJKPlayerVOD.this.mVideoView.getDuration();
                ...
                NSTIJKPlayerVOD.this.show(NSTIJKPlayerVOD.this.defaultTimeout);
                NSTIJKPlayerVOD.this.handler1.removeMessages(1);
                NSTIJKPlayerVOD.this.audioManager.setStreamMute(3, false);
                NSTIJKPlayerVOD.this.isDragging = false;
                NSTIJKPlayerVOD.this.handler1.sendEmptyMessageDelayed(1, 1000);
            }
        }
    };
    ...
    private void initVideoView(Context context) {
        ...
        this.vodPresenter = new VodPresenter(this, this.mAppContext);
        initBackground();
        initRenders();
        this.mVideoWidth = 0;
        this.mVideoHeight = 0;
        ...
        String string = this.loginPreferencesAfterLoginSubtitleSize.getString(AppConst.LOGIN_PREF_SUB_FONT_SIZE, "20");
        this.subtitleDisplay = new TextView(context);
        try {
            this.subtitleDisplay.setTextSize(2, Float.parseFloat(string));
    ...
    public void setVideoPath(String str, boolean z, String str2, long j, int i, String str3, ArrayList<LiveStreamsDBModel> arrayList, int i2, int i3, String str4) {
        setVideoURI(Uri.parse(str), z, str2, j, i, str3, arrayList, i2, i3, str4);
    }

    public void setVideoURI(Uri uri, boolean z, String str, long j, int i, String str2, ArrayList<LiveStreamsDBModel> arrayList, int i2, int i3, String str3) {
        setVideoURI(uri, null, z, str, j, i, str2, arrayList, i2, i3, str3);
    }

    private void setVideoURI(Uri uri, Map<String, String> map, boolean z, String str, long j, int i, String str2, ArrayList<LiveStreamsDBModel> arrayList, int i2, int i3, String str3) {
        this.mUri = uri;
        ...
        this.timeElapsed = j;
        this.openedStreamId = i;
        this.video_num = i3;
        this.liveListDetailAvailableChannels_temp = arrayList;
        this.playerResumeDBHandler = new PlayerResumeDBHandler(this.mActivity);
        this.recentWatchDBHandler = new RecentWatchDBHandler(this.mActivity);
        this.recentWatchDatabase1 = new SeriesRecentWatchDatabase(this.mActivity);
        this.seriesRecentClass = new SeriesRecentClass(this.mActivity);
        this.liveStreamDBHandler = new LiveStreamDBHandler(this.mActivity);
        this.userIdReferred = SharepreferenceDBHandler.getUserID(this.mActivity);
    ...
    public void setActivity(Activity activity, NSTIJKPlayerVOD nSTIJKPlayerVOD, SeekBar seekBar, TextView textView) {
        this.mActivity = activity;
        this.mVideoView = nSTIJKPlayerVOD;
    ...
    public void vodInfo(VodInfoCallback vodInfoCallback) {
        ...
        if (backdropPath != null && backdropPath.size() > 0) {
            try {
                Glide.with(this.mAppContext.getApplicationContext()).load(backdropPath.get(new Random().nextInt(backdropPath.size()))).asBitmap().into(new SimpleTarget<Bitmap>() {
                    /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass1 */
    ...
    private void setRecentWatchDB(Context context, ArrayList<LiveStreamsDBModel> arrayList, int i) {
        if (this.recentWatchDBHandler.getRecentwatchmoviesCount(SharepreferenceDBHandler.getUserID(context)) >= 100) {
            new ArrayList();
            ArrayList<LiveStreamsDBModel> allLiveStreasWithCategoryId = this.recentWatchDBHandler.getAllLiveStreasWithCategoryId(AppConst.EVENT_TYPE_MOVIE, SharepreferenceDBHandler.getUserID(context), "getOnedata");
            if (allLiveStreasWithCategoryId.isEmpty()) {
                this.recentWatchDBHandler.deleteRecentwatch(Integer.parseInt(allLiveStreasWithCategoryId.get(0).getStreamId()), AppConst.EVENT_TYPE_MOVIE);
            }
    ...
    private void setRecentWatchDBM3U(String str, String str2, String str3, String str4, Context context, ArrayList<LiveStreamsDBModel> arrayList, int i, long j, long j2) {
        if (this.liveStreamDBHandler.getRecentwatchCount(SharepreferenceDBHandler.getUserID(context), AppConst.EVENT_TYPE_MOVIE) >= 100) {
            new ArrayList();
            ArrayList<LiveStreamsDBModel> allLiveStreasWithCategoryId = this.liveStreamDBHandler.getAllLiveStreasWithCategoryId(AppConst.EVENT_TYPE_MOVIE, SharepreferenceDBHandler.getUserID(context), "getOnedata");
            if (allLiveStreasWithCategoryId.isEmpty()) {
                this.liveStreamDBHandler.deleteRecentwatch(str, AppConst.EVENT_TYPE_MOVIE, allLiveStreasWithCategoryId.get(0).getName(), SharepreferenceDBHandler.getUserID(context));
            }
            setDataIntoRecentWatchDBM3U(context, arrayList);
            return;
        }
        setDataIntoRecentWatchDBM3U(context, arrayList);
    }
    ...
    public void setDataIntoRecentWatchDBM3U(Context context, ArrayList<LiveStreamsDBModel> arrayList) {
        ...
        arrayList.get(this.currentWindowIndex).getStreamType();
        String streamId = arrayList.get(this.currentWindowIndex).getStreamId();
        String streamIcon = arrayList.get(this.currentWindowIndex).getStreamIcon();
        String epgChannelId = arrayList.get(this.currentWindowIndex).getEpgChannelId();
        String added = arrayList.get(this.currentWindowIndex).getAdded();
        String categoryId = arrayList.get(this.currentWindowIndex).getCategoryId();
        String customSid = arrayList.get(this.currentWindowIndex).getCustomSid();
        arrayList.get(this.currentWindowIndex).getTvArchive();
        String directSource = arrayList.get(this.currentWindowIndex).getDirectSource();
        String tvArchiveDuration = arrayList.get(this.currentWindowIndex).getTvArchiveDuration();
        String typeName = arrayList.get(this.currentWindowIndex).getTypeName();
        String categoryName = arrayList.get(this.currentWindowIndex).getCategoryName();
        String seriesNo = arrayList.get(this.currentWindowIndex).getSeriesNo();
        String live = arrayList.get(this.currentWindowIndex).getLive();
        ...
        panelAvailableChannelsPojo.setNum(Integer.valueOf(num));
        panelAvailableChannelsPojo.setName(name);
        panelAvailableChannelsPojo.setStreamType(AppConst.EVENT_TYPE_MOVIE);
        panelAvailableChannelsPojo.setStreamId(streamId);
        panelAvailableChannelsPojo.setStreamIcon(streamIcon);
        panelAvailableChannelsPojo.setEpgChannelId(epgChannelId);
        panelAvailableChannelsPojo.setAdded(added);
        ...
        liveStreamDBHandler2.addAllAvailableChannel(panelAvailableChannelsPojo, AppConst.EVENT_TYPE_MOVIE);
    }
    ...
    private int streamCheckSeries(String str, int i) {
        return this.recentWatchDatabase1.isStreamAvailable(str);
    }
    ...
    private void updateMovieElapsedStatus(int i, long j, long j2, int i2) {
        if (this.recentWatchDBHandler != null) {
            this.recentWatchDBHandler.updateResumePlayerStatuTimes(String.valueOf(i), AppConst.EVENT_TYPE_MOVIE, false, j, j2, i2);
        }
    }

    private void updateMovieElapsedStatusM3U(String str, long j, long j2, int i) {
        if (this.liveStreamDBHandler != null) {
            this.liveStreamDBHandler.updateResumePlayerStatuTimes(str, AppConst.EVENT_TYPE_MOVIE, false, j, j2, i);
        }
    }
    ...
    private void touchListner() {
        ...
        this.liveBox.setOnTouchListener(new OnTouchListener() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass3 */
            ...
            public boolean onTouch(View view, MotionEvent motionEvent) {
                ...
                if (NSTIJKPlayerVOD.this.gestureDetector.onTouchEvent(motionEvent)) {
                    return true;
                }
                if ((motionEvent.getAction() & 255) != 1) {
                    return false;
                }
                NSTIJKPlayerVOD.this.endGesture();
                return false;
            }
        });
    }
    ...
    public void statusChange(int i) {
        ...
        if (i == -1) {
            ...
            this.handler.postDelayed(new Runnable() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass5 */

                public void run() {
                    NSTIJKPlayerVOD.this.retryCount++;
                    NSTIJKPlayerVOD.this.hideAll();
                    Utils.showToast(NSTIJKPlayerVOD.this.mActivity, NSTIJKPlayerVOD.this.mActivity.getResources().getString(R.string.play_back_error) + " (" + NSTIJKPlayerVOD.this.retryCount + "/" + NSTIJKPlayerVOD.this.maxRetry + ")");
                    NSTIJKPlayerVOD.this.openVideo();
                    NSTIJKPlayerVOD.this.start();
                }
            }, 3000);
            ...
            if (type.equals("movies") && !this.appType.equals(AppConst.TYPE_M3U)) {
                setMovieWatched();
            } else if (type.equals("series") && !this.appType.equals(AppConst.TYPE_M3U)) {
                this.seriesRecentClass.setSeriesRecentWatched();
            }
            this.retryCount = 0;
    ...
    public void setMovieWatched() {
        ...
        if (VideoInfo.getInstance() != null && (streamCheckFun = streamCheckFun(VideoInfo.getInstance().getStreamid(), SharepreferenceDBHandler.getUserID(context))) <= 0 && streamCheckFun == 0) {
            setRecentWatchDB(context, VideoInfo.getInstance().getAvailableChannels(), VideoInfo.getInstance().getCurrentWindowIndex());
        }
    }
    ...
    public class PlayerGestureListener extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onScroll(MotionEvent motionEvent, MotionEvent motionEvent2, float f, float f2) {
            ...
            if (this.firstTouch) {
                ...
                if (x <= ((float) NSTIJKPlayerVOD.this.screenWidthPixels) * 0.5f) {
                    z = false;
                }
            ...
            if (!this.toSeek) {
                float height = y / ((float) NSTIJKPlayerVOD.this.mVideoView.getHeight());
                if (this.volumeControl) {
                    NSTIJKPlayerVOD.this.onVolumeSlide(height);
                } else {
                    NSTIJKPlayerVOD.this.onBrightnessSlide(height);
                }
            }
        ...
        public void hide(boolean z) {
            if (z || NSTIJKPlayerVOD.this.isShowing) {
                NSTIJKPlayerVOD.this.showBottomControl(false);
                NSTIJKPlayerVOD.this.$.id(R.id.app_video_top_box).gone();
                NSTIJKPlayerVOD.this.$.id(R.id.controls).gone();
                NSTIJKPlayerVOD.this.$.id(R.id.app_video_fullscreen).invisible();
                NSTIJKPlayerVOD.this.$.id(R.id.ll_seekbar_time).gone();
                NSTIJKPlayerVOD.this.hideTitleBarAndFooter();
            }
        }

        public boolean onSingleTapUp(MotionEvent motionEvent) {
            if (NSTIJKPlayerVOD.this.isShowing) {
                hide(false);
            } else {
                LinearLayout linearLayout = (LinearLayout) NSTIJKPlayerVOD.this.mActivity.findViewById(R.id.app_video_top_box);
                LinearLayout linearLayout2 = (LinearLayout) NSTIJKPlayerVOD.this.mActivity.findViewById(R.id.controls);
                LinearLayout linearLayout3 = (LinearLayout) NSTIJKPlayerVOD.this.mActivity.findViewById(R.id.ll_seekbar_time);
    ...
    public void AutoPlayNextPopup(Context context, String str) {
        View inflate = ((LayoutInflater) context.getSystemService("layout_inflater")).inflate((int) R.layout.auto_play_popup_layout, (ViewGroup) null);
        ...
        this.autoPlayNextPopup.setOnDismissListener(new PopupWindow.OnDismissListener() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass9 */

            public void onDismiss() {
                if (!(NSTIJKPlayerVOD.this.autoPlayHandler == null || NSTIJKPlayerVOD.this.autoPlayRunnable == null)) {
                    NSTIJKPlayerVOD.this.autoPlayHandler.removeCallbacks(NSTIJKPlayerVOD.this.autoPlayRunnable);
                }
                NSTIJKPlayerVOD.this.cancel_autoplay.performClick();
                NSTIJKPlayerVOD.this.hideSystemUi();
            }
        });
        this.cancel_autoplay.setOnClickListener(new OnClickListener() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass10 */

            public void onClick(View view) {
                NSTIJKPlayerVOD.this.hideAutoPlayScreen();
            }
        });
        this.fabButton.setOnClickListener(new OnClickListener() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass11 */
        ...
        linearLayout.setOnClickListener(new OnClickListener() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass12 */
    ...
    public void setListData(String str) {
        AutoPlayNextPopup(this.mActivity, str);
    }

    private void getRunnable() {
        boolean[] zArr = {false};
        this.autoPlayRunnable = new Runnable() {
            /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass14 */

            public void run() {
                int unused = NSTIJKPlayerVOD.this.currentProgress = NSTIJKPlayerVOD.this.currentProgress + 1;
                NSTIJKPlayerVOD.this.fabButton.setProgress((float) NSTIJKPlayerVOD.this.currentProgress);
                if (NSTIJKPlayerVOD.this.currentProgress <= 140) {
                    NSTIJKPlayerVOD.this.autoPlayHandler.postDelayed(NSTIJKPlayerVOD.this.autoPlayRunnable, 70);
                }
                if (NSTIJKPlayerVOD.this.currentProgress == 120) {
                    NSTIJKPlayerVOD.this.playNextEpisode();
                }
            }
        };
    ...
    public void playNextEpisode() {
        hideAutoPlayScreen();
        AppCompatImageView appCompatImageView = (AppCompatImageView) this.mActivity.findViewById(R.id.exo_next);
    ...
    public int toggleAspectRatio() {
        ...
        if (this.mRenderView != null) {
            ...
            this.handlerAspectRatio.postDelayed(new Runnable() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass21 */
                    ...
                    switch (trackType) {
                        case 1:
                            ...
                            radioGroup4.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass22 */

                                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                                    SharedPreferences.Editor unused = NSTIJKPlayerVOD.this.loginPrefsEditorVideo = NSTIJKPlayerVOD.this.loginPreferences_video_selected.edit();
                                    if (i == 111 || i == 11111111) {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorVideo.putInt(AppConst.LOGIN_PREF_CURRENT_VIDEO_TRACK, -1);
                                        NSTIJKPlayerVOD.this.deselectTrack(selectedTrack);
                                    } else {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorVideo.putInt(AppConst.LOGIN_PREF_CURRENT_VIDEO_TRACK, i);
                                        NSTIJKPlayerVOD.this.selectTrack(i);
                                        int currentPosition = NSTIJKPlayerVOD.this.mVideoView.getCurrentPosition();
                                        if (currentPosition != 0) {
                                            SharedPreferences unused2 = NSTIJKPlayerVOD.this.loginPreferences_seek_time = NSTIJKPlayerVOD.this.mActivity.getSharedPreferences(AppConst.LOGIN_PREF_CURRENT_SEEK_TIME, 0);
                                            NSTIJKPlayerVOD.this.loginPrefsEditorSeekTime = NSTIJKPlayerVOD.this.loginPreferences_seek_time.edit();
                                            NSTIJKPlayerVOD.this.loginPrefsEditorSeekTime.putString(AppConst.LOGIN_PREF_CURRENT_SEEK_TIME, String.valueOf(currentPosition));
                                            NSTIJKPlayerVOD.this.loginPrefsEditorSeekTime.apply();
                                        }
                                        NSTIJKPlayerVOD.this.openVideo();
                                        NSTIJKPlayerVOD.this.start();
                                    ...
                                    NSTIJKPlayerVOD.this.loginPrefsEditorVideo.apply();
                                    new Handler().postDelayed(new Runnable() {
                                        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass22.AnonymousClass1 */
                        ...
                        case 2:
                            ...
                            radioGroup5.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass23 */

                                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                                    SharedPreferences.Editor unused = NSTIJKPlayerVOD.this.loginPrefsEditorAudio = NSTIJKPlayerVOD.this.loginPreferences_audio_selected.edit();
                                    if (i == 1111 || i == 1111111) {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorAudio.putInt(AppConst.LOGIN_PREF_CURRENT_AUDIO_TRACK, -1);
                                        NSTIJKPlayerVOD.this.deselectTrack(selectedTrack2);
                                    } else {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorAudio.putInt(AppConst.LOGIN_PREF_CURRENT_AUDIO_TRACK, i);
                                        int currentPosition = (int) NSTIJKPlayerVOD.this.mMediaPlayer.getCurrentPosition();
                                        NSTIJKPlayerVOD.this.selectTrack(i);
                                        NSTIJKPlayerVOD.this.mMediaPlayer.seekTo(Long.parseLong(String.valueOf(currentPosition)));
                                    }
                                    NSTIJKPlayerVOD.this.loginPrefsEditorAudio.apply();
                                    new Handler().postDelayed(new Runnable() {
                                        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass23.AnonymousClass1 */
                        ...
                        case 3:
                            ...
                            radioGroup6.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
                                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass24 */

                                public void onCheckedChanged(RadioGroup radioGroup, int i) {
                                    SharedPreferences.Editor unused = NSTIJKPlayerVOD.this.loginPrefsEditorSubtitle = NSTIJKPlayerVOD.this.loginPreferences_subtitle_selected.edit();
                                    if (i == 11111 || i == 111111) {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorSubtitle.putInt(AppConst.LOGIN_PREF_CURRENT_SUBTITLE_TRACK, -1);
                                        NSTIJKPlayerVOD.this.deselectTrack(selectedTrack3);
                                    } else {
                                        NSTIJKPlayerVOD.this.loginPrefsEditorSubtitle.putInt(AppConst.LOGIN_PREF_CURRENT_SUBTITLE_TRACK, i);
                                        NSTIJKPlayerVOD.this.selectTrack(i);
                                    }
                                    NSTIJKPlayerVOD.this.loginPrefsEditorSubtitle.apply();
                                    new Handler().postDelayed(new Runnable() {
                                        /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass24.AnonymousClass1 */
    ...
    public void showMediaInfo() {
        if (this.mMediaPlayer != null) {
            ...
            this.dirsDialog.setOnDismissListener(new DialogInterface.OnDismissListener() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass25 */

                public void onDismiss(DialogInterface dialogInterface) {
                    if (NSTIJKPlayerVOD.this.mVideoView != null) {
                        NSTIJKPlayerVOD.this.mVideoView.hideSystemUi();
                    }
                }
            });
            this.dirsDialog.setOnShowListener(new DialogInterface.OnShowListener() {
                /* class com.nst.yourname.view.ijkplayer.widget.media.NSTIJKPlayerVOD.AnonymousClass26 */

                public void onShow(DialogInterface dialogInterface) {
                    Button unused = NSTIJKPlayerVOD.this.negativeButton = NSTIJKPlayerVOD.this.dirsDialog.getButton(-2);
                    NSTIJKPlayerVOD.this.negativeButton.setTag("1");
                    NSTIJKPlayerVOD.this.negativeButton.setOnFocusChangeListener(new OnFocusChangeAccountListener(NSTIJKPlayerVOD.this.negativeButton));
                    NSTIJKPlayerVOD.this.negativeButton.setTextColor(NSTIJKPlayerVOD.this.mActivity.getResources().getColor(R.color.white));
                    NSTIJKPlayerVOD.this.negativeButton.setTextSize(16.0f);
                    MarginLayoutParams marginLayoutParams = (MarginLayoutParams) NSTIJKPlayerVOD.this.negativeButton.getLayoutParams();
                    marginLayoutParams.setMargins(0, 10, 50, 10);
                    if ((NSTIJKPlayerVOD.this.mActivity.getResources().getConfiguration().screenLayout & 15) == 3) {
                        NSTIJKPlayerVOD.this.negativeButton.setBackground(NSTIJKPlayerVOD.this.mActivity.getResources().getDrawable(R.drawable.black_button_dark));
                        marginLayoutParams.width = PsExtractor.VIDEO_STREAM_MASK;
                        marginLayoutParams.height = TsExtractor.TS_STREAM_TYPE_E_AC3;
                        return;
                    }
                    NSTIJKPlayerVOD.this.negativeButton.setBackground(NSTIJKPlayerVOD.this.mActivity.getResources().getDrawable(R.drawable.back_btn_effect));
                    marginLayoutParams.width = PsExtractor.VIDEO_STREAM_MASK;
                    marginLayoutParams.height = TsExtractor.TS_STREAM_TYPE_E_AC3;
                }
            });
        ...
        public void onFocusChange(View view2, boolean z) {
            ...
            if (z) {
                if (this.view == null || this.view.getTag() == null || !this.view.getTag().equals("2")) {
                    ...
                    if (this.view != null && this.view.getTag() != null && this.view.getTag().equals("1") && NSTIJKPlayerVOD.this.negativeButton != null) {
                        NSTIJKPlayerVOD.this.negativeButton.setBackgroundResource(R.drawable.back_btn_effect);
                        return;
                    }
                    return;
                }
                view2.setBackground(NSTIJKPlayerVOD.this.getResources().getDrawable(R.drawable.selector_checkbox));
            } else if (!z) {
                if (!(this.view == null || this.view.getTag() == null || !this.view.getTag().equals("1") || NSTIJKPlayerVOD.this.negativeButton == null)) {
                    NSTIJKPlayerVOD.this.negativeButton.setBackgroundResource(R.drawable.black_button_dark);
                }
